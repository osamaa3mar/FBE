 ...
 */
 function showFirstAndLast(arr){
    let arr2 = [];
    arr.forEach(element => {
        arr2.push(`${element[0]}${element[element.length-1]}`);
    });
    return arr2;
 }
let a =['colt','matt', 'tim', 'udemy'];
 ...
 *
 */
let s = [{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}];
 ...
 console.log(addKeyAndValue(s,"title","ins"));
